                            ...
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Reservation
                                            submitted</td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Today, 10:30 AM
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div
                                                    class="w-8 h-8 rounded-full bg-gradient-to-r from-green-500 to-blue-500 mr-3">
                                                </div>
                                                <div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Payment received
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Yesterday, 3:45 PM
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div
                                                    class="w-8 h-8 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 mr-3">
                                                </div>
                                                <div>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Event registration
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Oct 12, 2:15 PM
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
