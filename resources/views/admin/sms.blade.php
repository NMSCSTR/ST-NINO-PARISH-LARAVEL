...
@section('title', 'SMS | Santo Niño Parish Church')
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">SMS</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $event->user->firstname }} {{ $event->middle_name }} {{ $event->user->lastname }}
                                    </th>
                                    <td class="px-6 py-4">
                                        {{ $event->title }}
                                    </td>
