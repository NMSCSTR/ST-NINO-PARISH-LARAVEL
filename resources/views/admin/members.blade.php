            ...
            <div class="lg:w-10/12 w-full">
                ...
                <div class="bg-white rounded-xl shadow-lg">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Members</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <div class="relative overflow-x-auto sm:rounded-lg  px-6 py-6">
                        <table id="datatable"
                            class="w-full text-sm text-left rtl:text-right text-gray-200 dark:text-gray-400">
                            <thead
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $member->user->firstname }} {{ $member->middle_name }} {{ $member->user->lastname }}
                                    </th>
                                    <td class="px-6 py-4">
                                        {{ $member->user->email }}
                                    </td>
