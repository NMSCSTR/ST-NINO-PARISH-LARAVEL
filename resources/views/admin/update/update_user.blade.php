                    ...
                    <form action="{{ route('admin.users.update', ['id' => $user->id]) }}" method="POST">
                        ...
                        <div class="grid gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="firstname" id="firstname"
                                    value="{{ old('firstname', $user->firstname) }}" required class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm
                            ...
                            <div>
                                ...
                                <input type="text" name="lastname" id="lastname"
                                    value="{{ old('lastname', $user->lastname) }}" required class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm
                                           focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition" />
                            </div>
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}"
                                    required class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm
                                           focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition" />
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone_number" id="phone_number"
                                value="{{ old('phone_number', $user->phone_number) }}" required class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm
                                           focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition" />
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <select name="role" id="role" required class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm
                                           focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="password" name="password" id="password" placeholder="••••••••" class="w-full rounded-xl border border-gray-300 bg-gray-50 px-4 py-2.5 text-sm
                                           focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 transition" />
                        </div>
