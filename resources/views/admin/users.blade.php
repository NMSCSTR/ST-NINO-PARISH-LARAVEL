                                    ...
                                    <td class="px-6 py-4 text-right">
                                        ...
                                        <div class="flex flex-wrap justify-end gap-2">
                                            ...
                                            <a href="{{ route('admin.users.edit', ['id' => $user->id]) }}"
                                                class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 transition shadow-sm">
                                            ...
                                            <a href="#" data-id="{{ $user->id }}"
                                                class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition shadow-sm delete-user-btn">
                                                <svg class="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                    stroke-width="2">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                            ...
                                            <!-- More Info Button (Members Only) -->
                                            @if($user->role === 'member')
                                            <button data-modal-target="memberModal{{ $user->id }}"
                                                data-modal-toggle="memberModal{{ $user->id }}"
                                                class="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 transition shadow-sm">
                                                <svg class="w-4 h-4 text-white" xmlns="http://www.w3.org/2000/svg"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                    stroke-width="2">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
